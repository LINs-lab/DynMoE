...
class ExampleModel(torch.nn.Module):
    def __init__(self):
        ...
        self._moe_layer = tutel_moe.moe_layer(
            gate_type = {'type': 'gated_multi_gate', 'max_expert_num': 16, 'fp32_gate': args.fp32_gate, 'adaptive_experts': True},
    ...
    def begin_adaptive_process(self):
        self._moe_layer.begin_record_routing()

    def finish_adaptive_process(self):
        self._moe_layer.adaptive_update_experts()
        self._moe_layer.end_record_routing()
...
torch.manual_seed(0 + args.local_rank)
