...
from .impls.generalized_fast_dispatch import fast_dispatcher, extract_critical, fast_encode, fast_decode

top_k_routing = extract_critical
# generalized_top_k_routing = generalized_extract_critical
