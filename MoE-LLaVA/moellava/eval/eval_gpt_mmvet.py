...
parser.add_argument('--model', type=str, default='gpt-4-0613', help='gpt model name for evaluation')
parser.add_argument('--api_key', type=str, default="", help='api key for gpt model')
parser.add_argument('--api_base', type=str, default="", help='api endpoint')
